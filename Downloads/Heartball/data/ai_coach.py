...
class AICoach:
    ...
    def suggest_play(self, down: int, yards_to_go: int) -> str:
        """
        Suggests a play based on the current game situation.

        Args:
            down (int): The current down (1-4).
            yards_to_go (int): The number of yards needed for a first down.

        Returns:
            str: The suggested play type ('Pass' or 'Run').
        """
